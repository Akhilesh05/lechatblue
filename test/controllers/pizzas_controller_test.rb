...
class PizzasControllerTest < ActionController::TestCase
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post :create, pizza: { available: @pizza.available, description: @pizza.description, image: @pizza.image, ingredients: @pizza.ingredients, name: @pizza.name, price: @pizza.price }
    end
  ...
  test "should update pizza" do
    patch :update, id: @pizza, pizza: { available: @pizza.available, description: @pizza.description, image: @pizza.image, ingredients: @pizza.ingredients, name: @pizza.name, price: @pizza.price }
    assert_redirected_to pizza_path(assigns(:pizza))
  end
